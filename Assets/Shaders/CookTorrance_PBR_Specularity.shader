Shader "CookTorrance_PBR_Specularity"
{
    Properties
    {
        [NoScaleOffset] _AlbedoMap("Albedo map", 2D) = "white" {}
        [NoScaleOffset] _SpecularMap("Specular/reflectivity map", 2D) = "white" {}
    ...
    SubShader
    {
        Pass
        {
            ...
            sampler2D _AlbedoMap, _SpecularMap, _RoughnessMap, _NormalMap, _AOMap;
            ...
            FragOut frag(v2f v) : SV_Target
            {
                ...
                float3 reflectivity = tex2D(_SpecularMap, v.uv).rgb;
