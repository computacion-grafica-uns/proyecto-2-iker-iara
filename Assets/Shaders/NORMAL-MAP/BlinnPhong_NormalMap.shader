Shader "BlinnPhong_NormalMap"
{
    Properties
    {
        ...
        _k_s            ("Specular",        Color)       = (1, 1, 1, 1)
        _n              ("Shininess",       Float)       = 32
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float     _NormalStrength, _n;
            float4    _k_a, _k_d, _k_s;
            ...
            FragOut frag(v2f v) : SV_Target {
                ...
                for (int i = 0; i < _L_Count; i++) {
                    ...
                    float4 diffuse  = _k_d * albedo * NL;
                    float4 specular = _k_s * pow(NH, _n) * NL;
